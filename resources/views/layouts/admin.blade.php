                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="https://as1.ftcdn.net/v2/jpg/03/46/83/96/1000_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg" alt="">
                                                </span>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li class="menu-item">
                                                <form method="POST" action="{{route('logout')}}" id="logout-form">
                                                    @csrf
                                                    <a href="{{route('logout')}}" class="flex" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                        <div class="icon"><i class="icon-settings"></i></div>
                                                        <div class="text" style="margin-left: 0.5rem;">Logout</div>
                                                    </a>
                                                </form>
                                            </li>
                                        </ul>
